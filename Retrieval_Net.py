...
with open('gpu_data_part1.csv', mode='w', newline='') as file:
...
while frame_idx < max_frames:
    ...
    if frame_idx % 10000 == 0 and frame_idx > 0:
        ...
        with open('gpu_data_part1.csv', mode='a', newline='') as file:
            writer = csv.writer(file)
            writer.writerow(["CFlowNets-Part1", frame_idx, gpu.load*100, gpu.memoryUsed])
